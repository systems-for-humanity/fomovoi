...
fun RecordingScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            // Microphone selector
            if (uiState.availableAudioDevices.isNotEmpty()) {
                Spacer(modifier = Modifier.height(8.dp))
                MicrophoneSelector(
                    devices = uiState.availableAudioDevices,
                    selectedDevice = uiState.selectedAudioDevice,
                    onDeviceSelected = viewModel::selectAudioDevice,
                    enabled = !uiState.isRecording && uiState.availableAudioDevices.size > 1,
                    modifier = Modifier.fillMaxWidth()
                )
            }
